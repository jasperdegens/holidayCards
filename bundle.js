...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = __webpack_require__(159);
	var style = __webpack_require__(169);

	ReactDOM.render(React.createElement(Card, null), document.getElementById('wrapper'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var letters = __webpack_require__(168);
	...
	var Card = React.createClass({
	  ...
	  getInitialState: function () {
	    return { isOpen: false, to: 'parents' };
	  },
	  ...
	  componentWillMount: function () {
	    ...
	    var recipient = params.split('=')[1];
	    this.setState({ to: recipient });
	  },

	  render: function () {
	    var cardDetails = letters[this.state.to];
	    var letter = cardDetails.letter;
	...
	var SlideShow = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      { className: classnames(this.props.className, 'slideshow') },
	      React.createElement(
